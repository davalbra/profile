...
export const navegacionDashboard: NavegacionDashboard[] = [
  ...
  {
    etiqueta: "Scrap",
    ruta: "/dashboard/scrap/vista-previa",
    icono: Database,
    subsecciones: [
      {
      ...
      {
        etiqueta: "Exportar",
        ruta: "/dashboard/scrap/exportar",
        icono: UploadCloud,
      },
      {
        etiqueta: "Mapa 3D",
        ruta: "/dashboard/scrap/mapa",
        icono: MapPinned,
      },
    ],
  },
...
export const modulosDashboard: ModuloDashboard[] = [
  ...
  },
  {
    ...
    funciones: [
      ...
      "Mapa 3D desde tablas guardadas en Neon",
      "Jerarquia de categorias Foursquare",
    ],
    integraciones: ["Foursquare OS Places", "Neon", "Three.js", "Iceberg"],
    accion: "Abrir scrap",
