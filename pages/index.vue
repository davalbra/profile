...
const repositorios = ref<RepositorioFijado[]>(
  repositoriosFijadosPredeterminados.repos,
)
...
<template>
  <div class="relative min-h-screen overflow-x-hidden text-slate-100">
      ...
      >
        ...
        <div class="flex items-center gap-2 md:gap-4">
          <div class="hidden items-center gap-7 md:flex">
            <a
              href="#home"
              class="text-sm font-medium text-white transition hover:text-[#5faaf3]"
              >Inicio</a
            >
            <a
              href="#projects"
    ...
    <main id="home" class="relative z-10 pt-24">
      <section
        class="mx-auto grid min-h-[calc(100vh-6rem)] w-full max-w-7xl grid-cols-1 items-center gap-12 px-4 pb-16 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-8"
      >
        <div class="animate-fade-in-up space-y-8">
          <div class="space-y-4">
            <div
              class="inline-flex items-center rounded-full border border-[#137fec]/25 bg-[#137fec]/10 px-3 py-1 font-mono text-xs font-medium tracking-wide text-[#5faaf3]"
            >
              <span
                class="mr-2 h-2 w-2 animate-pulse rounded-full bg-[#137fec]"
              />
              DASHBOARD PRIVADO · NUXT + MCP + BILLING
            </div>

            <h1
              class="text-balance text-5xl font-extrabold leading-[1.07] tracking-tight text-white sm:text-6xl lg:text-7xl"
            >
              Control center para <br />
              <span
                class="text-glow bg-gradient-to-r from-[#137fec] via-[#5faaf3] to-white bg-clip-text text-transparent"
              >
                módulos reales
              </span>
            </h1>
            ...
            <div class="space-y-3">
              <h2 class="font-mono text-lg text-slate-300 sm:text-xl">
                ...
                <span class="text-slate-400">
                  Billing · imágenes · n8n · Milka</span
                >
              </h2>
              <p
                class="max-w-xl text-base leading-relaxed text-slate-400 sm:text-lg"
              >
                Esta app no es solo una landing: agrupa herramientas operativas
                para consultar costos, optimizar assets, exponer capacidades MCP
                y administrar flujos privados desde un solo panel.
              </p>
            </div>
          </div>
        ...
        <div
          class="relative hidden min-h-[500px] items-center justify-center lg:flex"
        >
          <div
            class="pointer-events-none absolute inset-0 translate-x-10 translate-y-10 rounded-full bg-gradient-to-tr from-[#137fec]/25 via-transparent to-transparent blur-3xl"
          />

          <div
            class="code-glow relative mx-auto w-full max-w-md transition duration-500 hover:-translate-y-2"
          >
            <div
              class="flex items-center justify-between rounded-t-2xl border border-slate-700/60 bg-[#16222e] p-4"
            >
            ...
            <div
              class="relative overflow-hidden rounded-b-2xl border-x border-b border-slate-700/60 bg-[#0b1219] p-6 font-mono text-sm"
            >
              <div
                class="absolute bottom-0 left-0 top-0 w-10 select-none border-r border-slate-800 bg-[#16222e]/45 pr-2 pt-6 text-right leading-6 text-slate-600"
              >
                1<br />2<br />3<br />4<br />5<br />6<br />7<br />8<br />9<br />10<br />11
              </div>
              <div class="pl-8 leading-6 text-slate-200">
                <span class="text-violet-400">const</span> tools = [<span
                  class="text-orange-300"
                  >"optimize_image"</span
                >,
                <span class="text-orange-300">"billing_usage"</span
                >]<br /><br />
                <span class="text-violet-400">export async function</span>
                <span class="text-blue-400">POST</span>(request) {<br />
                <span class="text-slate-500"> validarTokenMcpOpcional()</span
                ><br />
                <span class="text-violet-400"> const</span> call =
                <span class="text-cyan-300">await</span> request.json()<br />
                <span class="text-violet-400"> if</span> (call.params.name ===
                <span class="text-orange-300">"billing_usage"</span>)<br />
                <span class="text-violet-400"> return</span>
                <span class="text-cyan-300">getBillingUsage</span>()<br /><br />
                <span class="text-violet-400"> return</span>
                <span class="text-cyan-300">optimizeImage</span
                >(call.params.arguments)<br />
                }
              </div>
            </div>

            <div
              class="absolute -bottom-8 -right-12 z-10 w-32 rounded-2xl border border-slate-700/50 bg-[#16222e] p-3 shadow-xl"
            >
            ...
            <div
              class="absolute -left-6 top-20 flex items-center gap-2 rounded-2xl border border-[#137fec]/20 bg-[#137fec]/10 px-3 py-1.5 text-xs text-white shadow-lg"
            >
      ...
      <section
        id="projects"
        class="mx-auto w-full max-w-7xl px-4 pb-8 sm:px-6 lg:px-8"
      >
        <div class="mb-5 flex flex-wrap items-end justify-between gap-4">
          <div>
            <div
              class="inline-flex items-center gap-2 rounded-full border border-[#137fec]/30 bg-[#137fec]/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#5faaf3]"
            >
            ...
            <p
              class="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base"
            >
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          ...
          >
            <div class="mb-4 flex items-start justify-between gap-4">
              <span
                class="inline-flex rounded-2xl border border-[#137fec]/20 bg-[#137fec]/10 p-2 text-[#5faaf3]"
              >
                <component :is="service.icon" class="h-4 w-4" />
              </span>
              <span
                class="rounded-full border border-slate-600/70 bg-[#0b1219]/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-slate-400"
              >
                {{ service.eyebrow }}
              </span>
            </div>
            ...
            <span
              class="mt-5 inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-[#5faaf3] transition group-hover:text-white"
            >
              Abrir módulo
              <ArrowRight
                class="h-4 w-4 transition group-hover:translate-x-1"
      ...
      >
        <div
          class="relative overflow-hidden rounded-[30px] border border-slate-700/70 bg-[#16222e]/65 p-6 backdrop-blur-sm lg:p-7"
        >
          <div
            aria-hidden="true"
            class="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[#137fec]/12 blur-3xl"
          />
          <div
            aria-hidden="true"
            class="pointer-events-none absolute -bottom-24 -left-20 h-64 w-64 rounded-full bg-cyan-400/10 blur-3xl"
          />
            ...
            <div class="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <p
                  class="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base"
                >
                  El proyecto separa UI, rutas server, datos, automatización y
                  procesamiento de archivos para mantener cada módulo aislado.
                </p>
              </div>

              <div class="flex flex-wrap gap-2 text-xs text-slate-300">
                <span
                  class="rounded-2xl border border-slate-600/70 bg-[#0f1a26]/80 px-3 py-1.5"
                >
                  12 piezas clave
                </span>
                <span
                ...
                <div class="relative z-10">
                  <div class="mb-4 flex items-center justify-between">
                    <div class="inline-flex items-center gap-2">
                      <span
                        class="inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-white/5 ring-1 ring-slate-600/60"
                      >
                        <component
                          :is="group.icon"
                      ...
                      <h3
                        class="text-sm font-bold uppercase tracking-[0.14em] text-slate-300"
                      >
                        {{ group.name }}
                      </h3>
                    </div>
                    <span class="text-xs text-slate-500"
                      >{{ group.items.length }} herramientas</span
                    >
                  </div>
                  ...
                  <div class="grid gap-2.5">
                    ...
                    >
                      <span
                        class="inline-flex items-center gap-2 text-slate-200"
                      >
      ...
      <section class="mx-auto w-full max-w-7xl px-4 pb-8 sm:px-6 lg:px-8">
        <div
          class="rounded-[30px] border border-slate-700/70 bg-[#16222e]/65 p-6 backdrop-blur-sm"
        >
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            ...
            >
              ...
              <div
                class="mt-4 flex flex-wrap items-center gap-3 text-xs text-slate-400"
              >
                ...
                <span
                  class="rounded-xl border border-slate-700 bg-slate-800 px-2 py-1 font-medium text-slate-300"
                >
                  {{ repo.language }}
                </span>
                <span class="inline-flex items-center gap-1">
      ...
      >
        <div
          class="rounded-[30px] border border-[#137fec]/30 bg-gradient-to-r from-[#0b1219] to-[#16222e] p-6"
        >
          <h2 class="text-2xl font-bold text-white">Operar el proyecto</h2>
          <p class="mt-2 max-w-2xl text-sm text-slate-300">
            Usa el dashboard para revisar costos, ejecutar herramientas MCP,
            administrar imágenes o entrar a las utilidades Milka.
          </p>
    ...
    <div
      class="fixed bottom-0 right-0 h-px w-1/3 bg-gradient-to-l from-[#137fec]/30 to-transparent"
    />
    <div
      class="fixed left-0 top-0 h-px w-1/3 bg-gradient-to-r from-[#137fec]/30 to-transparent"
    />
