            ...
            <div
              ...
              <div class="pl-8 leading-6 text-slate-200">
                <span class="text-violet-400">const</span> tools = [<span
                  class="text-orange-300">"optimize_image"</span>, <span class="text-orange-300">"billing_usage"</span>]<br><br>
                <span class="text-violet-400">export async function</span> <span class="text-blue-400">POST</span>(request)
                {<br>
                <span class="text-slate-500">  validarTokenMcpOpcional()</span><br>
                <span class="text-violet-400">  const</span> call = <span class="text-cyan-300">await</span>
                request.json()<br>
          ...
          <div class="relative z-10">
            <div class="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <p class="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base">
                  El proyecto separa UI, rutas server, datos, automatización y procesamiento de archivos para mantener
                  cada módulo aislado.
                </p>
              </div>
      ...
      <section id="contact" class="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div class="rounded-[30px] border border-[#137fec]/30 bg-gradient-to-r from-[#0b1219] to-[#16222e] p-6">
          ...
          <p class="mt-2 max-w-2xl text-sm text-slate-300">
            Usa el dashboard para revisar costos, ejecutar herramientas MCP, administrar imágenes o entrar a las
            utilidades Milka.
          </p>
