...
import {Copy, ImagePlus, Loader2, RefreshCcw, Sparkles, Trash2, Upload} from "lucide-react";
        ...
        <Card>
            <CardHeader className="space-y-3">
                <div>
                    ...
                    <CardDescription>
                        Flujo separado para optimizar nuevas imágenes y revisar histórico con métricas reales.
                    </CardDescription>
                </div>
                        ...
                        <section className="space-y-4 rounded-lg border p-4">
                            <div className="flex flex-wrap items-center justify-between gap-2">
                                ...
                                <Button size="sm" onClick={() => void handleUploadAll()}
                                        disabled={busy || !user || !files.length}>
                            ...
                            <div className="rounded-lg border border-dashed border-border p-4 text-sm">
                                <p className="mb-2 text-muted-foreground">
                                    Formatos soportados: `png`, `jpg`, `jpeg`, `webp`, `avif`, `heic`, `heif`, `gif`,
                                    `tiff`, `bmp`, `svg`.
                                </p>
                                <input
